...
function calculatePageNumber (i, currentPage, maxButtons, totalPages) { // i == 1, currentPage == 8, maxButtons == 1, totalPages == 10
  let halfWay = Math.ceil(maxButtons / 2) // halfWay == 1
  if (maxButtons === 1) {
    return currentPage
